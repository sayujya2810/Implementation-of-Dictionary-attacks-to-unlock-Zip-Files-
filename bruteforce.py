...
def main():
    """
    Program that does a bruteforce dictionary attack to find the password of a
    ...
    parser.add_argument('-l', required=True, metavar='file', dest='dictionary',help='Specify dictionary file')
    parser.add_argument('-f', required=True, metavar='file', dest='zipfilename',type=checkZip,help='Specify ZIP file')
